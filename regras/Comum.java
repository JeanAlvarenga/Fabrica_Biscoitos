public class Comum extends Biscoito{
    ...
    public String toString() {
        ...
        if(calcularTempo() < 60){
            s = "tipo biscoito comum, tempo de produção: " + (int)calcularTempo() + " seg. " + 
            ...
            s = "tipo biscoito comum, tempo de produção: " + minuto + " min, " + segundo + " seg, " + 
            calcularQuantidadeBiscoitos() + " biscoitos produzidos. "+ super.toString();
        }
        else{
            ...
            s = "tipo biscoito comum, " + "quantidade: "+ calcularQuantidadeBiscoitos() +
